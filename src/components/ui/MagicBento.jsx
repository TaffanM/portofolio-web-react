...
const BentoCardGrid = ({ children, gridRef }) => (
	<div
		className="bento-section grid gap-3 p-0 max-w-5xl select-none relative w-full"
	...
	return (
		<>
          ...
          .bento-section {
            ...
            --accent-border: rgba(224, 224, 224, 0.6);
          ...
          .card--border-glow:hover {
            box-shadow: 0 8px 30px rgba(0, 0, 0, 0.5), 0 0 40px rgba(${glowColor}, 0.3);
			...
			<BentoCardGrid gridRef={gridRef}>
				<div className="card-responsive">
					{cards.map((card, index) => {
						const baseClassName = `card flex flex-col relative min-h-[220px] w-full p-6 sm:p-7 rounded-2xl border-2 font-light overflow-hidden ${
						...
						if (enableStars) {
							return (
								...
								>
									<div className="card__header flex justify-between items-start gap-3 relative mb-5">
									...
									<div className="card__content flex flex-col relative flex-1">
										...
										<div className="skill-pills-container">
											{card.skills && card.skills.map((skill, skillIndex) => (
